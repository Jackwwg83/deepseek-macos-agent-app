...
1. DeepSeek-compatible URL, such as `https://api.deepseek.com/beta` or an OpenAI-compatible `/v1` endpoint.
2. DeepSeek API key.
...
- DeepSeek URL must use HTTPS unless it points to localhost.
